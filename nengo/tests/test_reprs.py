...
def test_transforms():
    ...
    check_repr(Convolution(n_filters=3, input_shape=(3, 4, 5), groups = 3))
    assert (
    ...
    assert (
        repr(Conv(n_filters=3, input_shape=(3, 4, 5), groups = 3))
        == "Convolution(n_filters=3, input_shape=(3, 4, 5), groups=3)"
    )
